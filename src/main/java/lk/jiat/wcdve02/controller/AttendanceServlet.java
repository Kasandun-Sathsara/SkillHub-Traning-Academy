...
import lk.jiat.wcdve02.model.Attendance;
...
public class AttendanceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("delete".equals(action)) {
            ...
            ds.getAttendances().removeIf(a -> a.getId() == id);
            resp.sendRedirect(req.getContextPath() + "/attendance");
            return;
        }
        
        req.setAttribute("attendances", ds.getAttendances());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("add".equals(action)) {
            try {
                ...
                boolean present = "on".equals(req.getParameter("present"));
                ...
                if (sOpt.isPresent() && cOpt.isPresent()) {
                    Attendance a = new Attendance(ds.generateAttendanceId(), sOpt.get(), cOpt.get(), date, present);
                    ds.getAttendances().add(a);
                }
            } catch (Exception e) {
